...
import { rooms, createRoom, deleteRoom, handleActivePlayerRemoved, emitRoomState, MAX_PLAYERS_PER_ROOM, MAX_ROOMS } from './rooms';
import { createSocketEventLimiter, createKeyedEventLimiter } from './rateLimit';
...
// Every per-connection limiter above lives in its connection's own closure,
// so a scripted client could reset all of them simply by reconnecting — this
// caps how often that trick can be pulled. Generous for real players (even a
