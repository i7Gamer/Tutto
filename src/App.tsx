...
function ToastItem({ toast, removeToast }: ToastItemProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-900/90 dark:bg-slate-800 text-white px-4 py-2 rounded-xl shadow-lg font-medium border border-gray-700 sm:backdrop-blur-md text-sm max-w-[calc(100vw-2rem)] break-words text-center pointer-events-auto"
    >
      {toast.message}
    </motion.div>
  );
