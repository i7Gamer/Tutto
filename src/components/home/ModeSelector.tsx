      ...
      <div className="inline-grid gap-4 sm:contents">
        <div className="flex gap-2 sm:gap-4 sm:mb-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold transition-all ${mode === 'local' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30' : 'bg-white dark:bg-slate-800/50 text-gray-700 dark:text-gray-200 hover:bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600'}`}
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className={`flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold transition-all ${mode === 'online' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30' : 'bg-white dark:bg-slate-800/50 text-gray-700 dark:text-gray-200 hover:bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600'}`}
        ...
        {!hasActiveRoom && (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-center gap-2 px-6 py-2 rounded-lg bg-white dark:bg-slate-800/40 hover:bg-white dark:bg-slate-800/80 border border-gray-200 dark:border-slate-600 text-gray-700 dark:text-gray-200 font-medium transition-all sm:w-full sm:max-w-xs justify-center"
            onClick={onShowStats}
          >
