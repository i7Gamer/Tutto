...
export default function TurnScoreHeader({ turnScore, pendingSelectionScore, isClassic, chainCardCount, currentCard, tuttosThisTurn }: TurnScoreHeaderProps) {
  ...
  return (
    <div className="text-center mb-6 sm:mb-8">
      ...
      {/* The live region is this wrapper, not the number: the number is keyed
          by turnScore and therefore remounts on every change, and a region
          that appears together with its content is not announced. */}
