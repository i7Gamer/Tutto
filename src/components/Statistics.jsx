          ...
          {tab === 'personal' && (
            ...
            >
              <h3 className="text-xl font-bold mb-6 text-center text-gray-700 dark:text-gray-200">
                {t('statistics.onlineLifetimeRecord', 'Online Lifetime Record (This Device)')}
              </h3>
              ...
              {!p || !p.gamesPlayed ? (
                ...
                <div className="w-full">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    ...
                    <StatTile icon={<TrendingUp size={32} className="text-indigo-400" />} value={p.totalTurns ? Math.round((p.totalScore || 0) / p.totalTurns) : 0} label={t('statistics.avgPointsPerTurn', 'Avg Points/Turn')} colorClass="text-indigo-600 dark:text-indigo-400" bgClass="bg-indigo-50 dark:bg-indigo-900/20 border-indigo-100 dark:border-indigo-500/30" />
            ...
            >
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">
                  {t('statistics.globalCommunityTitle', 'Global Community Statistics')}
                </h3>
                <p className="text-gray-500 dark:text-gray-400 font-medium">{t('statistics.globalDescription', 'Aggregated across all local and online games played.')}</p>
              </div>
              ...
              {!g || !g.totalGamesPlayed ? (
                ...
                <div className="w-full">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    ...
                    <StatTile icon={<TrendingUp size={32} className="text-indigo-400" />} value={g.totalTurns ? Math.round((g.totalScore || 0) / g.totalTurns) : 0} label={t('statistics.avgPointsPerTurn', 'Avg Points/Turn')} colorClass="text-indigo-600 dark:text-indigo-400" bgClass="bg-indigo-50 dark:bg-indigo-900/20 border-indigo-100 dark:border-indigo-500/30" />
