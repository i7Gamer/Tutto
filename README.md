...
- **Invite Links & QR Codes:** Share a room as a link that opens the lobby with the code already filled in — copy it, hand it to your phone's share sheet, or show a QR code for the person sitting next to you to scan with their own camera. No app-side scanner needed.
